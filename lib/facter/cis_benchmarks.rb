...
Facter.add('cis_benchmarks_temp_dir') do
...
Facter.add('cis_benchmarks') do
  ...
  setcode do
    cis_benchmarks = {}
    cis_temp_dir = Facter.value(:cis_benchmarks_temp_dir)

    Facter::Core::Execution.exec("test -d #{cis_temp_dir}/cis_scripts")

    # redhat v2.1.1 = 6.1.10
    ww_files = script_exec("#{cis_temp_dir}/cis_scripts/cis_ww_files.sh")

    # redhat v1.0.0 = , v2.1.1 = 1.1.21
    ww_dirs = script_exec("#{cis_temp_dir}/cis_scripts/cis_ww_dirs.sh")

    # redhat v1.0.0 = 1.2.3, v2.1.1 = 1.8
    yum_updates = script_exec("#{cis_temp_dir}/cis_scripts/cis_yumupdates.sh")

    # redhat v1.0.0 = 1.4.6, v2.1.1 = 1.6.1.6
    unconfined_daemons = script_exec("#{cis_temp_dir}/cis_scripts/cis_unconfined_daemons.sh")

    # redhat v1.0.0 = 1.2.1, v2.1.1 = 1.2.4
    redhat_network = script_exec("#{cis_temp_dir}/cis_scripts/cis_redhat_network.sh")

    # redhat v1.0.0 = 1.1.2, v2.1.1 = 1.2.3
    redhat_gpg = script_exec("#{cis_temp_dir}/cis_scripts/cis_redhat_gpg.sh")
    ...
    system_acct = script_exec("#{cis_temp_dir}/cis_scripts/cis_disable_sys_acct.sh")

    # redhat v1.0.0 = 9.1.11, v2.1.1 = 6.1.11
    unowned_files = script_exec("#{cis_temp_dir}/cis_scripts/cis_unowned_files.sh")

    # redhat v1.0.0 = 9.1.12 , v2.1.1 = 6.1.12
    ungrouped_files = script_exec("#{cis_temp_dir}/cis_scripts/cis_ungrouped_files.sh")

    # redhat v1.0.0 = 9.1.13, v2.1.1 = 6.1.13,
    suid_exec = script_exec("#{cis_temp_dir}/cis_scripts/cis_suid_exec.sh")

    # redhat v1.0.0 = 9.1.14, v2.1.1 = 6.1.14
    sgid_exec = script_exec("#{cis_temp_dir}/cis_scripts/cis_sgid_exec.sh")

    # redhat v1.0.0 = 9.2.1, v2.1.1 = 6.2.1
    password_fields = script_exec("#{cis_temp_dir}/cis_scripts/cis_password_fields.sh")

    # redhat v1.0.0 = 9.2.2, v2.1.1 = 6.2.2
    legacy_entry_passwd = script_exec("#{cis_temp_dir}/cis_scripts/cis_legacy_entry.sh /etc/passwd")
    legacy_entry_shadow = script_exec("#{cis_temp_dir}/cis_scripts/cis_legacy_entry.sh /etc/shadow")
    legacy_entry_group = script_exec("#{cis_temp_dir}/cis_scripts/cis_legacy_entry.sh /etc/group")

    # redhat v1.0.0 = 9.2.5, v2.1.1 = 6.2.5
    uid = script_exec("#{cis_temp_dir}/cis_scripts/cis_uid_0.sh")

    # redhat v1.0.0 = 9.2.14, v2.1.1 = 6.2.16
    dup_uid = script_exec("#{cis_temp_dir}/cis_scripts/cis_dup_uid.sh")

    # redhat v1.0.0 = 9.2.15, v2.1.1 = 6.2.17
    dup_gid = script_exec("#{cis_temp_dir}/cis_scripts/cis_dup_gid.sh")

    # redhat v1.0.0 = , v2.1.1 =
    res_uid = script_exec("#{cis_temp_dir}/cis_scripts/cis_res_uid.sh")

    # redhat v1.0.0 = 9.2.17 , v2.1.1 = 6.2.18
    dup_name = script_exec("#{cis_temp_dir}/cis_scripts/cis_dup_name.sh")

    # redhat v1.0.0 =9.2.15 , v2.1.1 = 6.2.17,6.2.19
    dup_group = script_exec("#{cis_temp_dir}/cis_scripts/cis_dup_group.sh")

    # redhat v1.0.0 = , v2.1.1 =
    netrc = script_exec("#{cis_temp_dir}/cis_scripts/cis_netrc.sh .netrc")

    # redhat v1.0.0 = 9.2.19, v2.1.1 = 6.2.12
    forward = script_exec("#{cis_temp_dir}/cis_scripts/cis_netrc.sh .forward")

    # redhat v1.0.0 = 9.2.13, v2.1.1 = 6.2.9
    userhome = script_exec("#{cis_temp_dir}/cis_scripts/cis_userhome.sh")

    # redhat v1.0.0 = 9.2.12, v2.1.1 = 6.2.7

    validhome = script_exec("#{cis_temp_dir}/cis_scripts/cis_validhome.sh")
    # redhat v1.0.0 = 9.2.11, v2.1.1 = 6.2.15

    checkgroup = script_exec("#{cis_temp_dir}/cis_scripts/cis_checkgroup.sh")
    # redhat  v2.1.1 = 6.2.6

    verify_root = script_exec("#{cis_temp_dir}/cis_scripts/cis_verify_root_path.sh")
    # redhat v2.1.1 = 6.2.8

    validate_user_homes = script_exec("#{cis_temp_dir}/cis_scripts/cis_validate_user_home_perm.sh")

    # redhat v2.1.1 = 6.2.10
    validate_user_dot_files = script_exec("#{cis_temp_dir}/cis_scripts/cis_user_dot_files_verified.sh")

    # redhat v2.1.1 = 6.2.14
    user_rhosts = script_exec("#{cis_temp_dir}/cis_scripts/cis_find_user_dot_rhosts.sh")
