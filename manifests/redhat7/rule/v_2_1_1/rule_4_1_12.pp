...
class cis_benchmarks::redhat7::rule::v_2_1_1::rule_4_1_12 (
  Array $cis_audit_partitions = lookup("cis_benchmarks::${::cis_benchmarks::cis_version}::cis_audit_partitions",Array,'first',$::cis_benchmarks::params::cis_cis_audit_partitions)
