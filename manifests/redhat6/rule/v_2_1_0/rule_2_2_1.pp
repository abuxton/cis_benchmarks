...
class cis_benchmarks::redhat6::rule::v_2_1_0::rule_2_2_1 (
  ...
  case $time_service {
    'ntp': {
        class {'::cis_benchmarks::redhat6::rule::v_2_1_0::rule_2_2_1_2':
          time_service => $time_service,
          time_server  =>  $time_server,
        }
      }
    'chrony':{
      class {'::cis_benchmarks::redhat6::rule::v_2_1_0::rule_2_2_1_3':
        time_service => $time_service,
        time_server  =>  $time_server,
      }
